#!/usr/bin/env python3
"""
Restaura webhooks.py para versão funcional
"""
...
webhooks_file.write_text(webhooks_content)

print("✅ webhooks.py restaurado com versão funcional!")
print("\n📝 O que foi corrigido:")
print("- analyze_text está na classe base WebhookProcessor")
print("- execute_plugin usa doc_id (string) corretamente")
print("- Apenas o webhook /custom está implementado (simplificado)")
print("\n🚀 A API deve recarregar automaticamente. Teste agora!")